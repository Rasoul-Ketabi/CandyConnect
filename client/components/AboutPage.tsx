...
const AboutPage: React.FC<AboutPageProps> = ({ onBack }) => {
  ...
  const handleGitHubClick = () => {
    ...
    window.open('https://github.com/AmiRCandy/CandyConnect', '_blank');
  };
  ...
  return (
    <div className={`space-y-6 ${isRTL ? 'text-right' : 'text-left'}`}>
      ...
      <div className={`flex items-center ${isRTL ? 'flex-row-reverse space-x-reverse space-x-4' : 'space-x-4'}`}>
        ...
        <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-200">{t('about')}</h2>
      </div>

      {/* App Info */}
      <div className="space-y-4">
        {/* App Icon and Name */}
        <div className={`flex items-center ${isRTL ? 'flex-row-reverse space-x-reverse space-x-4' : 'space-x-4'} bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm border border-slate-200/50 dark:border-slate-700/50`}>
          ...
          <div>
            <h3 className="text-xl font-bold text-slate-800 dark:text-slate-200">CandyConnect</h3>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl p-4 shadow-sm border border-slate-200/50 dark:border-slate-700/50">
          <div className={`flex items-center justify-between ${isRTL ? 'flex-row-reverse' : ''}`}>
            <div className={`flex items-center ${isRTL ? 'flex-row-reverse space-x-reverse space-x-3' : 'space-x-3'}`}>
              ...
              <div>
                <p className="font-medium text-slate-800 dark:text-slate-200">{t('version')}</p>
                <p className="text-sm text-slate-500 dark:text-slate-400">1.0.0</p>
              </div>
            </div>
          </div>
        </div>
        ...
        >
          <div className={`flex items-center justify-between ${isRTL ? 'flex-row-reverse' : ''}`}>
            <div className={`flex items-center ${isRTL ? 'flex-row-reverse space-x-reverse space-x-3' : 'space-x-3'}`}>
              ...
              <div>
                <p className="font-medium text-slate-800 dark:text-slate-200">{t('github')}</p>
                <p className="text-sm text-slate-500 dark:text-slate-400">github.com/AmiRCandy/CandyConnect</p>
              </div>
            </div>
